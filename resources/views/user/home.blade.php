            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                <div class="space-y-8 opacity-0 -translate-x-8 animate-[fadeInLeft_0.8s_ease-out_forwards]">
                    ...
                    <div class="flex flex-wrap gap-4">
                        ...
                        <a href="#sarana"
                            class="px-8 py-4 bg-white text-slate-700 rounded-xl font-semibold border border-slate-200 hover:border-costume-primary hover:text-costume-primary transition-all">
                            Lihat Katalog
                        </a>
                    </div>
