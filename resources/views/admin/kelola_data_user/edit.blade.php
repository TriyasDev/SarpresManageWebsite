...
@section('content')
    ...
    <div class="bg-white rounded-[30px] shadow-sm border border-gray-100 p-6 lg:p-10">
        <div class="flex items-start justify-between mb-6">
            <h2 class="text-lg lg:text-xl font-bold text-gray-800">Edit Data User</h2>
            {{-- Info chip --}}
            <span class="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-semibold rounded-[30px] border border-blue-200 mt-1">
                {{ $user->rank ?? 'Reliant' }}
            </span>
        </div>

        <form action="{{ route('admin.kelola_data_user.update', $user->id_user) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="username" value="{{ old('username', $user->username) }}" placeholder="Masukkan nama lengkap"
                    ...
                    <div>
                        ...
                        <input type="text" name="no_telpon" value="{{ old('no_telpon', $user->no_telpon) }}" placeholder="Masukkan no telepon"
                    ...
                    {{-- Password Baru --}}
                    <div>
                        <label class="block text-gray-800 font-medium mb-2 text-sm">Password Baru</label>
                        <div class="relative">
                    ...
                    <div>
                        ...
                        <input type="text" name="nipd" value="{{ old('nipd', $user->nipd) }}" placeholder="Masukkan NIPD"
                ...
                <div class="space-y-5">
                    ...
                    <div>
                        ...
                        <input type="text" value="{{ $user->rank ?? 'Reliant' }}" readonly
                            class="w-full px-5 py-3 border-2 border-gray-200 rounded-[30px] bg-gray-50 text-gray-500 text-sm cursor-not-allowed" />
                        <p class="text-xs text-gray-400 mt-1 pl-3">Rank dikelola otomatis berdasarkan poin peminjam.</p>
                    </div>

                    {{-- Poin (Read-only) --}}
                    <div>
                        <label class="block text-gray-800 font-medium mb-2 text-sm">Poin</label>
