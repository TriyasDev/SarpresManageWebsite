{{-- resources/views/admin/kelola_data_user/create.blade.php --}}
@extends('layouts.admin')
@section('title', 'Tambah User - KlikAset')
    ...
    <form method="POST" action="{{ route('users.store') }}">
        ...
        <div class="bg-white rounded-[30px] shadow-sm border border-gray-100 p-6 lg:p-10">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
                <div class="space-y-5">
                    <div>
                        ...
                        <input type="text" name="username" value="{{ old('username') }}" class="w-full px-5 py-3 border-2 border-gray-300 rounded-[30px] outline-none focus:ring-2 focus:ring-costume-second focus:border-transparent text-sm transition @error('username') border-red-400 @enderror"/>
                    ...
                    <div>
                        ...
                        <input type="email" name="email" value="{{ old('email') }}" class="w-full px-5 py-3 border-2 border-gray-300 rounded-[30px] outline-none focus:ring-2 focus:ring-costume-second focus:border-transparent text-sm transition @error('email') border-red-400 @enderror"/>
                    ...
                    <div>
                        ...
                        <input type="text" name="no_telpon" value="{{ old('no_telpon') }}" class="w-full px-5 py-3 border-2 border-gray-300 rounded-[30px] outline-none focus:ring-2 focus:ring-costume-second focus:border-transparent text-sm transition"/>
                    </div>
                ...
                <div id="peminjamFields" class="space-y-5">
                    <div>
                        ...
                        <input type="text" name="nipd" value="{{ old('nipd') }}" class="w-full px-5 py-3 border-2 border-gray-300 rounded-[30px] outline-none focus:ring-2 focus:ring-costume-second focus:border-transparent text-sm transition"/>
                    </div>
                    <div>
                        <label class="block text-gray-800 font-medium mb-2 text-sm">Kelas</label>
                        <input type="text" name="kelas" value="{{ old('kelas') }}" class="w-full px-5 py-3 border-2 border-gray-300 rounded-[30px] outline-none focus:ring-2 focus:ring-costume-second focus:border-transparent text-sm transition"/>
                    </div>
                    <div>
                        <label class="block text-gray-800 font-medium mb-2 text-sm">Alamat</label>
                        <input type="text" name="alamat" value="{{ old('alamat') }}" class="w-full px-5 py-3 border-2 border-gray-300 rounded-[30px] outline-none focus:ring-2 focus:ring-costume-second focus:border-transparent text-sm transition"/>
                    </div>
                    <div>
                        <label class="block text-gray-800 font-medium mb-2 text-sm">Tanggal Lahir</label>
                        <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir') }}" class="w-full px-5 py-3 border-2 border-gray-300 rounded-[30px] outline-none focus:ring-2 focus:ring-costume-second focus:border-transparent text-sm transition"/>
                    </div>
                    <div>
            ...
            <div class="flex gap-3 mt-8">
                ...
                <button type="submit" class="flex-1 bg-costume-primary text-white px-5 py-3 rounded-[30px] font-semibold text-sm hover:bg-blue-700 transition shadow-sm">Simpan</button>
            </div>
        </div>
    </form>
