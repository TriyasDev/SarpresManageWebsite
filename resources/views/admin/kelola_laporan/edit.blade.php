...
<div class="mb-6 flex items-center gap-3">
    ...
    <span class="text-gray-800 font-semibold text-sm">Edit Laporan #{{ $laporan->id_laporan }}</span>
</div>
...
<form action="{{ route('admin.kelola_laporan.update', $laporan->id_laporan) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    ...
    <div class="bg-white rounded-[30px] shadow-sm border border-gray-100 p-6 lg:p-10">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div class="space-y-5">
                ...
                {{-- Jenis Laporan --}}
                <div>
                    <label class="block text-gray-800 font-medium mb-2 text-sm">Jenis Laporan:</label>
                    <div class="relative">
                        <select
                            name="jenis_laporan"
            ...
            <div class="flex flex-col gap-5">
                ...
                <div class="flex gap-3 mt-auto">
                    ...
                    <button type="submit"
                        class="flex-1 bg-costume-primary text-white px-5 py-3 rounded-[30px] font-semibold text-sm hover:bg-blue-700 transition shadow-md"
                    >
                        Simpan Perubahan
                    </button>
                </div>
