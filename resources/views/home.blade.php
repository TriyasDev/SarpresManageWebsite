        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div class="space-y-8 opacity-0 -translate-x-8 animate-[fadeInLeft_0.8s_ease-out_forwards]">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="#pinjam" class="group px-8 py-4 bg-costume-primary text-white rounded-xl font-semibold hover:bg-costume-primary/90 transition-all shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 flex items-center gap-2">
                        Ajukan Peminjaman
                        <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
                        </svg>
                    </a>
                    <a href="#sarana" class="px-8 py-4 bg-white text-slate-700 rounded-xl font-semibold hover:border-costume-primary hover:text-costume-primary">
                        Lihat Katalog
                    </a>
                </div>
...
<section class="py-24 bg-white" id="mengapa-kami">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {{-- Feature 1 --}}
            <div class="group bg-white rounded-2xl border border-slate-200 p-8 text-center hover:border-costume-primary hover:shadow-xl transition-all duration-300 cursor-pointer opacity-0 translate-y-5 [&.visible]:opacity-100 [&.visible]:translate-y-0" style="transition-delay: 0ms" data-animate>
            ...
            {{-- Feature 2 --}}
            <div class="group bg-white rounded-2xl border border-slate-200 p-8 text-center hover:border-emerald-500 hover:shadow-xl transition-all duration-300 cursor-pointer opacity-0 translate-y-5 [&.visible]:opacity-100 [&.visible]:translate-y-0" style="transition-delay: 100ms" data-animate>
            ...
            {{-- Feature 3 --}}
            <div class="group bg-white rounded-2xl border border-slate-200 p-8 text-center hover:border-violet-500 hover:shadow-xl transition-all duration-300 cursor-pointer opacity-0 translate-y-5 [&.visible]:opacity-100 [&.visible]:translate-y-0" style="transition-delay: 200ms" data-animate>
            ...
            {{-- Feature 4 --}}
            <div class="group bg-white rounded-2xl border border-slate-200 p-8 text-center hover:border-amber-500 hover:shadow-xl transition-all duration-300 cursor-pointer opacity-0 translate-y-5 [&.visible]:opacity-100 [&.visible]:translate-y-0" style="transition-delay: 300ms" data-animate>
...
<section class="py-24 bg-slate-50" id="sarana">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="flex flex-wrap justify-center gap-3 mb-12 opacity-0 translate-y-5 [&.visible]:opacity-100 [&.visible]:translate-y-0 transition-all duration-700" data-animate>
            <button class="px-6 py-2.5 bg-costume-primary text-white rounded-full font-medium text-sm shadow-md shadow-blue-500/25 hover:shadow-lg transition-all">
                Semua
            </button>
            <button class="px-6 py-2.5 bg-white text-slate-700 rounded-full font-medium text-sm border border-slate-200 hover:border-costume-primary hover:text-costume-primary transition-all">
                Elektronik
            </button>
            <button class="px-6 py-2.5 bg-white text-slate-700 rounded-full font-medium text-sm border border-slate-200 hover:border-costume-primary hover:text-costume-primary transition-all">
                Multimedia
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="group bg-white rounded-2xl border border-slate-200 overflow-hidden hover:border-costume-primary hover:shadow-xl transition-all duration-300 opacity-0 translate-y-5 [&.visible]:opacity-100 [&.visible]:translate-y-0" data-animate>
                <div class="relative h-48 bg-linear-to-br from-slate-100 to-slate-200 overflow-hidden">
                    <img src="{{ asset($asset['image']) }}" alt="{{ $asset['title'] }}" class="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500">
                    <div class="absolute top-3 right-3 px-3 py-1.5 @if($asset['available'] > 10) bg-emerald-500 @elseif($asset['available'] > 5) bg-amber-500 @else bg-orange-500 @endif text-white text-xs font-bold rounded-full shadow-lg">
...
<section class="py-24 bg-white" id="pinjam">
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div class="group bg-white rounded-2xl border border-slate-200 overflow-hidden hover:border-costume-primary hover:shadow-xl hover:-translate-y-1 transition-all duration-300 opacity-0 translate-y-5 [&.visible]:opacity-100 [&.visible]:translate-y-0" data-animate>
                <div class="relative h-56 bg-linear-to-br from-slate-100 to-slate-200 overflow-hidden">
                    ...
                    <div class="absolute top-3 left-3 px-3 py-1.5 bg-white/95 backdrop-blur-sm rounded-full shadow-lg">
                        <div class="flex items-center gap-2">
                            <div class="w-2 h-2 @if($item['available'] > 10) bg-emerald-500 @else bg-amber-500 @endif rounded-full animate-pulse"></div>
                ...
                <div class="p-6">
                    ...
                    {{-- Borrow Button --}}
                    <a href="{{ route('auth.login') }}" class="block w-full py-3.5 bg-costume-primary text-white text-center rounded-xl font-semibold hover:bg-costume-primary/90 transition-all shadow-lg shadow-blue-500/25 hover:shadow-xl hover:shadow-blue-500/30 group">
        ...
        {{-- View All Button --}}
        {{-- <div class="text-center opacity-0 translate-y-5 [&.visible]:opacity-100 [&.visible]:translate-y-0 transition-all duration-700" data-animate>
            <a href="{{ route('login') }}" class="inline-flex items-center gap-2 px-10 py-4 bg-white text-slate-700 rounded-xl font-semibold border-2 border-slate-200 hover:border-costume-primary hover:text-costume-primary transition-all shadow-sm hover:shadow-lg group">
                Lihat Semua Aset
                <svg class="w-5 h-5 group-hover:translate-x-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 8l4 4m0 0l-4 4m4-4H3"/>
                </svg>
