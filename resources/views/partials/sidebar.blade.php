<aside id="sidebar" class="fixed inset-y-0 left-0 transform -translate-x-full lg:translate-x-0 transition-transform duration-300
    ...
    <nav class="flex-1 space-y-1.5 px-4 overflow-y-auto">
        ...
        <a href="{{ route('admin.kelola_aset.index') }}" class="group flex items-center gap-3 px-4 py-2.5 rounded-[30px] text-white font-bold text-[0.96rem] transition-all duration-200 @if(request()->is('admin/kelola_aset*')) bg-costume-second @else hover:bg-costume-second @endif">
        ...
        <a href="{{ route('admin.kelola_laporan.index') }}" class="group flex items-center gap-3 px-4 py-2.5 rounded-[30px] text-white font-bold text-[0.96rem] transition-all duration-200 @if(request()->is('admin/kelola_laporan*')) bg-costume-second @else hover:bg-costume-second @endif">
